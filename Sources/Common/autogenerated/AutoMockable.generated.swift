...
public class LoggerMock: Logger, Mock {
    ...
    public func resetMock() {
        ...
        mockCalled = false // do last as resetting properties above can make this true
        forceCallsCount = 0
        forceReceivedArguments = nil
        forceReceivedInvocations = []
    ...
    /// Number of times the function was called.
    public private(set) var forceCallsCount = 0
    /// `true` if the function was ever called.
    public var forceCalled: Bool {
        forceCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    public private(set) var forceReceivedArguments: String?
    /// Arguments from *all* of the times that the function was called.
    public private(set) var forceReceivedInvocations: [String] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var forceClosure: ((String) -> Void)?

    /// Mocked function for `force(_ message: String)`. Your opportunity to return a mocked value and check result of
    /// mock in test code.
    public func force(_ message: String) {
        mockCalled = true
        forceCallsCount += 1
        forceReceivedArguments = message
        forceReceivedInvocations.append(message)
        forceClosure?(message)
    }
}
...
/**
 Class to easily create a mocked version of the `SDKSetupChecklist` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class SDKSetupChecklistMock: SDKSetupChecklist, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    public func resetMock() {
        noStepsCompleteDeepLinksCallsCount = 0

        mockCalled = false // do last as resetting properties above can make this true
        completedDeepLinkStepCallsCount = 0
        completedDeepLinkStepReceivedArguments = nil
        completedDeepLinkStepReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
    }

    // MARK: - noStepsCompleteDeepLinks

    /// Number of times the function was called.
    public private(set) var noStepsCompleteDeepLinksCallsCount = 0
    /// `true` if the function was ever called.
    public var noStepsCompleteDeepLinksCalled: Bool {
        noStepsCompleteDeepLinksCallsCount > 0
    }
    ...
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var noStepsCompleteDeepLinksClosure: (() -> Void)?

    /// Mocked function for `noStepsCompleteDeepLinks()`. Your opportunity to return a mocked value and check result of
    /// mock in test code.
    public func noStepsCompleteDeepLinks() {
        mockCalled = true
        noStepsCompleteDeepLinksCallsCount += 1
        noStepsCompleteDeepLinksClosure?()
    }

    // MARK: - completedDeepLinkStep

    /// Number of times the function was called.
    public private(set) var completedDeepLinkStepCallsCount = 0
    /// `true` if the function was ever called.
    public var completedDeepLinkStepCalled: Bool {
        completedDeepLinkStepCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    public private(set) var completedDeepLinkStepReceivedArguments: (step: SDKSetupDeepLinkStep, deepLink: URL)?
    /// Arguments from *all* of the times that the function was called.
    public private(set) var completedDeepLinkStepReceivedInvocations: [(step: SDKSetupDeepLinkStep, deepLink: URL)] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var completedDeepLinkStepClosure: ((SDKSetupDeepLinkStep, URL) -> Void)?

    /// Mocked function for `completedDeepLinkStep(_ step: SDKSetupDeepLinkStep, deepLink: URL)`. Your opportunity to
    /// return a mocked value and check result of mock in test code.
    public func completedDeepLinkStep(_ step: SDKSetupDeepLinkStep, deepLink: URL) {
        mockCalled = true
        completedDeepLinkStepCallsCount += 1
        completedDeepLinkStepReceivedArguments = (step: step, deepLink: deepLink)
        completedDeepLinkStepReceivedInvocations.append((step: step, deepLink: deepLink))
        completedDeepLinkStepClosure?(step, deepLink)
    }
}
