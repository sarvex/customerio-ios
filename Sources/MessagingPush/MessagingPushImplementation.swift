...
internal class MessagingPushImplementation: MessagingPushInstance {
    ...
    let sdkSetupChecklist: SDKSetupChecklist
    ...
    internal init(
        ...
        sdkSetupChecklist: SDKSetupChecklist
    ) {
        self.siteId = siteId
        self.logger = logger
        ...
        self.sdkSetupChecklist = sdkSetupChecklist
    }
    ...
    internal init(diGraph: DIGraph) {
        ...
        self.sdkSetupChecklist = diGraph.sDKSetupChecklist
    }
